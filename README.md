...
- Accurately predict the probability of a loanee defaulting on a vehicle loan in the first EMI (Equated Monthly Instalments) on the due date.

#### Dataset Description

Following information regarding the loan and loanee are provided in the datasets:<br>

- Loanee Information (Demographic data like age, identity proof etc)<br>
- Loan Information (Disbursal Details, Loan to value ratio etc)<br>
- Bureau data & history (Bureau score, number of active accounts, the status of othe loans, credit history etc)<br>
